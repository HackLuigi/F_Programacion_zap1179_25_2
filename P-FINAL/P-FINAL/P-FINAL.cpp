...
int main()
{
    ...
    case 1:
        ...
        case 2:
            cout << "Oye, puede de que sea asi, pero al menos hago lo que me hace feliz";
            system("pause");
            system("cls");
            cout << "Despues de eso, has visto a " << chara << " y han hablado seguido y se hicieron buenos amigos, pero solo termino en eso, una simple y sencilla amistad";
            system("pause");
            system("cls");
            cout << "Final 4 de 6: Amistad";
            system("pause");
            system("cls");
    ...
    case 2:
        cout << "???: '¡Oye! ¡Eres un idiota y un agresivo! ¡Dejame en paz!";
        system("pause");
        system("cls");
        cout << "Despues de eso, te pega y despues no la has vuelto a ver";
        system("pause");
        system("cls");
        cout << "Final 2 de 6: Grosero";
        system("pause");
        system("cls");
