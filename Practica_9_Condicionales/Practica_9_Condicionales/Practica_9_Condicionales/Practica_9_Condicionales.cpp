...
int main()
{
    ...
    while (decision == false)
    {
        ...
        case 1:
            ...
            std::cin >> numero_1;
            std::cin >> numero_2;
            std::cout << "Sus numero sumados serian " << numero_1 + numero_2 << " que tenga buen dia" << std::endl;
            std::cout << "¿Le gustaria hacer una ecuacion mas ? (0 para si, 1 para no)" << std::endl;
            std::cin >> decision;
            break;
